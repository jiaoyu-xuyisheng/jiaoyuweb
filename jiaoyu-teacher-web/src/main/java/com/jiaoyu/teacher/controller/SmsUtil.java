...
public class SmsUtil {
    ...
    public SendSmsResponse sendSms(Map<String,String> map) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI0oDnlHXxdFCv", "NUZHURs0llpSXpIHT1uh4f86JP73LO");
        ...
        //必填:短信签名-可在短信控制台中找到sign_name
        request.setSignName(map.get("sign_name"));
        //必填:短信模板-可在短信控制台中找到template_code
        request.setTemplateCode(map.get("template_code"));
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为param
